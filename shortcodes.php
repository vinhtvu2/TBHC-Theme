...
function sc_events_widget() {
	...
	'<p class="screen-only moreBtn">'.esi_include('output_weather_data').'<a href="https://events.ucf.edu/calendar/2862/the-burnett-honors-college/upcoming/" class="home_col_morelink">More Events</a></p>';
}
