...
function sc_events_widget() {
	...
	'<div class="screen-only moreBtn"><a href="https://events.ucf.edu/calendar/2862/the-burnett-honors-college/upcoming/" class="home_col_morelink">More Events</a>'.'bloopBLOOP'.'</div>';
}
