...
function get_people_from_org_group(){
	echo '[person-profile-grid org_groups=\''.$_REQUEST['org_groups'].'\' '.(!empty($_REQUEST['dd_org_groups']) ? 'dd_org_groups=\''.$_REQUEST['dd_org_groups'].'\' dropdown=true'.(!empty($_REQUEST['dd2_org_groups']) ? 'dd2_org_groups=\''.$_REQUEST['dd2_org_groups'].'\' dropdown2=true' : '') : '').' show_org_groups=\''.$_REQUEST['show_org_groups'].'\']';
	die();
}
